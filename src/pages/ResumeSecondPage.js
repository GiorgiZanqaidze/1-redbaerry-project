      ...
      <section className='single-part-resume side-paddings bg-dark-white'>
        ...
        <form className='second-page-form'>
            ...
            return (
              <div key={index} className="form-container">
                ...
                <div className='form-controller grit-item width-100'>
                    ...
                    <textarea id='description' name='description' type="text" placeholder='როლი თანამდებობაზე და ზოგადი აღწერა' className='width-100' onChange={(event) => handleChangeInput(index, event)} value={description}/>
                </div>
              </div>
            )
          })}
          ...
          <div className='button-container two-input-container'>
            ...
            <button className='bg-dark-blue border-radius white-font' onClick={toSecondPage}>შემდეგი</button>
          </div>
        </form>
      </section>
